    ...
    <div className="space-y-8">
      ...
      <div className="relative flex items-center justify-center py-12 px-4">
        ...
        <div className="flex flex-col items-center justify-center space-y-6 text-center z-10 w-full max-w-xl">
          ...
          <div className="relative w-full mt-4 z-50" ref={searchContainerRef}>
            ...
            <input
              type="text"
              className="block w-full pl-11 pr-4 py-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-slate-200/60 dark:border-slate-800 rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] dark:shadow-none focus:shadow-[0_4px_25px_-4px_rgba(6,81,237,0.15)] focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none"
            ...
            {showSuggestions && searchQuery && (
              <div className="absolute w-full mt-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800 rounded-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] dark:shadow-2xl z-50 overflow-hidden max-h-60 overflow-y-auto hidden-scrollbar">
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/20 dark:bg-black/50 backdrop-blur-sm">
          <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-3xl w-full max-w-md p-6 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-2xl border border-white/50 dark:border-slate-800">
      ...
      {deleteConfirmId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/20 dark:bg-black/50 backdrop-blur-sm">
          <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-3xl w-full max-w-sm p-6 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-2xl border border-white/50 dark:border-slate-800 text-center">
