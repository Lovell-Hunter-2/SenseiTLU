...
export default function DonateModal({ isOpen, onClose }: DonateModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-slate-200 dark:border-slate-800 bg-gradient-to-r from-rose-50 to-orange-50 dark:from-rose-950/30 dark:to-orange-950/30">
        ...
        <div className="p-6 text-center">
          <p className="text-slate-700 dark:text-slate-300 font-medium italic mb-6">
